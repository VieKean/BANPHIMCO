...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="detail-page/styledetail.css">
        <link rel="stylesheet" href="detail-page/reset.css">
    </head>

    <body>
        <div class="detail">
            <div class="detail-content1">
                <div class="detail-content1_img">
                    <img src="../../QUANLI/ASSETS/img/IMG-Product/<?php echo $row_SP['hinhanh']; ?>" alt="">
                </div>
                <div class="detail-content1_infor">
                    <div class="product-name">
                        <h1><?php echo $row_SP['tensanpham']; ?></h1>
                    </div>
                    <div class="product-price">
                        <h3> Giá hiện tại là: </h3>
                        <p> <?php echo number_format($row_SP['gia']); ?> </p>
                    </div>
                    <div class="assurance">
                        <h4> Hàng đảm bảo 100% chất lượng bảo hành lên đến 12 tháng </h4>
                    </div>
                    <div class="btn">

                        <a href="<?php if(isset($_SESSION['username'])){echo '../home-login.php?page=./GUEST/module/buyprd.php&id='.$id.'';}else{echo '../LOGIN/form-login.php';} ?>">
            ...
            <div class="detail-content2">
                <div class="detail-content2_description">
                    <h3> Mô tả sản phẩm </h3>
                    <p> <?php echo $row_SP['mota']; ?></p>
                </div>
            </div>
            <a href="<?php if (isset($_SESSION['username'])) {
                            echo '../home-login.php?page=product.php';
                        } else {
                            echo '../home.php?page=product.php';
                        } ?>">
...
<?php } else {
    header("Location:../home.php?error=Sản phẩm không tồn tại");
} ?>