...
<table class="main-table">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM khachhang" . $date_filter . " LIMIT $items_per_page OFFSET $offset";
...
<div class="btn-pagination">
    <?php if ($npage > 1): ?>
        <a href="?page=dskhachhang&npage=1<?php echo isset($selectedDate) ? '&ngaytao=' . $selectedDate : ''; ?>">&laquo; First</a>
        <a href="?page=dskhachhang&npage=<?php echo $npage - 1; ?><?php echo isset($selectedDate) ? '&ngaytao=' . $selectedDate : ''; ?>">&lt; Prev</a>
    <?php endif; ?>
    ...
    <?php if ($npage < $total_pages): ?>
        <a href="?page=dskhachhang&npage=<?php echo $npage + 1; ?><?php echo isset($selectedDate) ? '&ngaytao=' . $selectedDate : ''; ?>">Next &gt;</a>
        <a href="?page=dskhachhang&npage=<?php echo $total_pages; ?><?php echo isset($selectedDate) ? '&ngaytao=' . $selectedDate : ''; ?>">Last &raquo;</a>
    <?php endif; ?>
</div>
