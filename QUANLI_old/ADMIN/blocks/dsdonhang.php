...
<div class="btn-pagination">
    <?php if ($npage > 1): ?>
        <a href="?page=dsdonhang&npage=1<?php echo isset($selectedDate) ? '&ngaydathang=' . $selectedDate : ''; ?><?php echo isset($selectedStatus) ? '&trangthai=' . $selectedStatus : ''; ?>">&laquo; First</a>
        <a href="?page=dsdonhang&npage=<?php echo $npage - 1; ?><?php echo isset($selectedDate) ? '&ngaydathang=' . $selectedDate : ''; ?><?php echo isset($selectedStatus) ? '&trangthai=' . $selectedStatus : ''; ?>">&lt; Prev</a>
    <?php endif; ?>
    ...
    <?php if ($npage < ceil($total_orders / $items_per_page)): ?>
        <a href="?page=dsdonhang&npage=<?php echo $npage + 1; ?><?php echo isset($selectedDate) ? '&ngaydathang=' . $selectedDate : ''; ?><?php echo isset($selectedStatus) ? '&trangthai=' . $selectedStatus : ''; ?>">Next &gt;</a>
        <a href="?page=dsdonhang&npage=<?php echo ceil($total_orders / $items_per_page); ?><?php echo isset($selectedDate) ? '&ngaydathang=' . $selectedDate : ''; ?><?php echo isset($selectedStatus) ? '&trangthai=' . $selectedStatus : ''; ?>">Last &raquo;</a>
    <?php endif; ?>
</div>
