...
// Add pagination to the query only if not filtering or searching
...
<?php if (!$isFilteringOrSearching): ?>
    <div class="btn-pagination">
        <?php if ($tpage > 1): ?>
            <a href="?page=dssanpham&tpage=1">&laquo; First</a>
            <a href="?page=dssanpham&tpage=<?php echo $tpage - 1; ?>">&lt; Prev</a>
        <?php endif; ?>
        ...
        <?php if ($tpage < $total_pages): ?>
            <a href="?page=dssanpham&tpage=<?php echo $tpage + 1; ?>">Next &gt;</a>
            <a href="?page=dssanpham&tpage=<?php echo $total_pages; ?>">Last &raquo;</a>
        <?php endif; ?>
    </div>
<?php endif; ?>
